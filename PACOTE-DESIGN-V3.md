# Pacote design v3 — os 6 arquivos, na íntegra

Arquivo de transferência. Cada seção abaixo é um arquivo COMPLETO, para salvar
no caminho indicado dentro do projeto do app. Nada aqui é exemplo: é o conteúdo
aprovado no protótipo, com os valores exatos da paleta.

Os três primeiros **substituem** arquivos existentes; os três últimos são **novos**.
Os passos de integração estão em APLICAR-DESIGN-DEFINITIVO.md (seções 2 a 5).
...
Aplicado isto, rode pnpm dev e siga a seção 5 do guia.
